...
echo '2'
flex lexer.l		#creates the lexical analyzer or scanner named lex.yy.c
...
echo '5'
./a.out	inp.c code.asm Code.asm log.txt	# you will need to provide proper input files with ./a.out command as instructed in assignment specification
